package com.learn.tutorial.springboot.chapter4.config;

import com.learn.tutorial.springboot.chapter4.entities.ReleaseItem;
import com.learn.tutorial.springboot.chapter4.entities.ReleaseNote;
...
public class ProjectConfig {
    ...
    public Collection<ReleaseNote> loadReleaseNotes() {
        ...
        ReleaseNote releaseNote2 = ReleaseNote.builder()
                ...
                .commitTag("44047f3")
                .newReleases(Set.of(getReleaseItem("SBIP-125",
                        "Support both kebab-case and camelCase as Spring init CLI Options #28138")))
                .bugFixes(Set.of(getReleaseItem("SBIP-126",
    ...
    private ReleaseItem getReleaseItem(String itemId, String itemDescription) {
        return new ReleaseItem(itemId, itemDescription);
    }
